 ...
 * @LastEditTime: 2023-03-28 13:45:16
 * @FilePath: /canvas_image/src/App.jsx
 * @Description: 这是默认设置,请设置`customMade`, 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 */
import { useState, useRef, useEffect } from "react";
// import fire1 from "./assets/img1/Normal_20230323095349.jpg"; //平塘县
// import fire1_black from "./assets/img1/Normal_20230323213824.jpg"; //平塘县
...
// import fire1 from './assets/img2/wuliangye.jpg'; //五粮液
// import fire1_black from './assets/img2/wuliangye_black.jpg'; //五粮液
// 牟坪镇红农村
import fire1 from './assets/img3/nong.jpg'; //五粮液
import fire1_black from './assets/img3/nong_black.jpg'; //五粮液
...
function App() {
  ...
  useEffect(() => {
    ...
    Promise.all([loadImage(image1), loadImage(image2)]).then((images) => {
      ...
      // [{"bottom":890,"cx":221,"cy":866,"lat":0,"left":201,"lon":0,"pan":-10.612477811058197,"right":241,"tilt":4.724384636399436,"top":842}]

      // 遍历像素数据，将矩形外的像素颜色值设置为透明
      // for (let y = 0; y < canvas.height; y++) {
      //   for (let x = 0; x < canvas.width; x++) {
      //     if (x < 200 || x > 241 || y < 830 || y > 900) {
      ...
      for (let i = 0; i < data.length; i += 4) {
        ...
        //   data[i + 3] = 0;
        // }
        if (data[i] < 66 && data[i + 1] < 66 && data[i + 2] < 66) {
          data[i + 3] = 0;
        }
      }
